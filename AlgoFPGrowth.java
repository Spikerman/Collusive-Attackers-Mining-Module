...
public class AlgoFPGrowth {
     ...
     * @param miniReviewAppNum the minimum support threshold.
     * @return the result if no output file path is provided.
     * @throws IOException exception if error reading or writing files
     */
    public Itemsets runAlgorithm(String input, String output, int miniReviewAppNum, int groupSize) throws FileNotFoundException, IOException {
        // record start time
        startTimestamp = System.currentTimeMillis();
        // number of itemsets found
        itemsetCount = 0;
        this.userGroupSize = groupSize;
        ...
        this.minSupportRelative = miniReviewAppNum;
    ...
    private void saveItemset(int[] itemset, int itemsetLength, int support) throws IOException {
        ...
        if (writer != null) {
            ...
            for (int i = 0; i < itemsetLength; i++) {
                ...
                System.out.print(itemsetOutputBuffer[i] + "  ");
